...
#include "ChatingBiLin.h"

chating::BiLin::BiLin(HttpSession *http_session, const string &pro_name) : Chating(http_session,pro_name)
{
...
int chating::BiLin::IsBiLin(HttpSession *http_session)
{
...
int chating::BiLin::Process(const char *packet,int action)
{
...
int chating::BiLin::SendVoiceMessageM(const char *packet)
{
