...
#define WEIXINPHONEBOOK						4

#define ACTION_RECYCLEREQ					0x80
#define ACTION_MESSAGEREQ					0x81
#define ACTION_ROLLBACKREQ					0x82
#define ACTION_IDENTITYREQ					0X83
#define ACTION_CLOUDDATAREQ					0X84
#define ACTION_CALLREQ						0X85
...
#define QQSYNCASIST_DATABUF_LEN				QQPIM_DECRYPTBUF_LEN		//64K
#define QQSYNCASIST_UPDATABUF_LEN			QQPIM_DECRYPTBUF_LEN

#define QQPIM_TIMEOUT						180
...
void MySplitString(CString strSrc ,CStringArray &arrayDest,char * sep);
