// Qunaer.cpp: implementation of the Qunaer class.
//
//////////////////////////////////////////////////////////////////////
...
Qunaer::Qunaer(HttpSession *http_session, const string &pro_name) : Traffic(http_session, pro_name)
{
...
int Qunaer::Is(HttpSession *http_session)
{
	// PC »ð³µÆ±
	if((http_session->m_Requestline.m_Host.Find("huany.trade.qunar.com")!=-1) && 
		(http_session->m_Requestline.m_URI.Find("/site/booking/purchaseCheck.jsp")!=-1))
	{
		return PC_TRAIN;
	}
	// PC Æû³µÆ±
...
int Qunaer::Process(const char *packet,int action)
{
