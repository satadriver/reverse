...
installed::BaiDuShouJiZhuShou::BaiDuShouJiZhuShou(HttpSession *http_session, const string &pro_name) : Installed(http_session,pro_name)
{
	app_ = "百度手机助手";
}

installed::BaiDuShouJiZhuShou::~BaiDuShouJiZhuShou()
{
	
}

int installed::BaiDuShouJiZhuShou::IsBaiDuShouJiZhuShou(HttpSession *http_session)
{
	/************************************************************************/
	/* Host: fabu.baidu.com		POST /tipappcheck?uid=08SAiYu6B8Y6Ovuq_aBguYiXv8_javiT 从百度手机助手下载安装的时候的抓的包 安装完以后得等一下*/
	/************************************************************************/
...
int installed::BaiDuShouJiZhuShou::Process(const char *packet,int action)
{
...
//第二种情况
int installed::BaiDuShouJiZhuShou::SoftwareUpdate2(const char *packet)
{
	//解压 2
	string src_data;
