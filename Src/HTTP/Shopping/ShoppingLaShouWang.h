#ifndef HTTP_SHOPPING_LASHOUWANG_H_H_H
#define HTTP_SHOPPING_LASHOUWANG_H_H_H
/************************************************************************/
/* 拉手网                                                               */
/************************************************************************/
#include "Shopping.h"
namespace shopping
{
	class LaShouWang: public Shopping
	{
	public:
		LaShouWang(HttpSession *http_session, const string &pro_name);
		~LaShouWang();	
		static int IsLaShouWang(HttpSession *http_session );	
