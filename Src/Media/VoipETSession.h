#ifndef VOIP_ET_H_H_H
#define VOIP_ET_H_H_H
#include "voip.h"


class VoipETSession : public MediaSession
{
public:
	VoipETSession(DATEHEADER& packh, int aT, char * Packet);
	virtual ~VoipETSession();
	virtual int InsertPacket(DATEHEADER& packh, const char *pPacket);
	virtual int ListToFile();
	static BOOL IsVoipET(DATEHEADER& packh, const char *pPacket);
