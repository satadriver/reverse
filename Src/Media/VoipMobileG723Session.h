#ifndef VOIP_MOBILE_G723_SESSION_H_H_H
#define VOIP_MOBILE_G723_SESSION_H_H_H
#include "voip.h"

class VoipMobileG723Session : public MediaSession
{
public:
	VoipMobileG723Session(DATEHEADER& packh, int aT, char * Packet);
	virtual ~VoipMobileG723Session();
	virtual int InsertPacket(DATEHEADER& dataheader,const char *pPacket);
	virtual int ListToFile();
	static BOOL IsVoipMobileg723(DATEHEADER& dataheader,const char *pPacket);
