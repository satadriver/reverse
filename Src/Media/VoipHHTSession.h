#ifndef VOIP_HHT_SESSION_H_H_H
#define VOIP_HHT_SESSION_H_H_H
#include "voip.h"

class VoipHHTSession : public MediaSession
{
public:
	VoipHHTSession(DATEHEADER& packh, int aT, char * pPacket);
	virtual ~VoipHHTSession();	
	virtual int InsertPacket(DATEHEADER& packh, const char *pPacket);
	virtual int ListToFile();
	static BOOL IsVoipHHT(DATEHEADER& packh, const char *pPacket);
