#ifndef VOIP_MOBILE_HHCALL_SESSION_H_H_H
#define VOIP_MOBILE_HHCALL_SESSION_H_H_H
#include "voip.h"


class VoipMobileHHCALLSession : public MediaSession
{
public:
	VoipMobileHHCALLSession(DATEHEADER& packh, int aT, char * Packet);
	virtual ~VoipMobileHHCALLSession();
	virtual int InsertPacket(DATEHEADER& packh, const char *pPacket);
	virtual int ListToFile();
	static	BOOL IsVoipMobileHHCALL(DATEHEADER& packh, const char *pPacket);
