/* Copyright (C) 2000 zwsql AB & Yuri Dario
...
/* Defines for OS2 to make it compatible for zwsql */
...
#define VERSION ZWSQL_SERVER_VERSION
/* Default socket */
#define ZWSQL_UNIX_ADDR "\\socket\\zwsql"
...
/* zwsql client protocoll version */
