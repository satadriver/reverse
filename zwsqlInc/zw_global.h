...
#if defined( __EMX__) && !defined( ZWSQL_SERVER)
...
#undef remove		/* Crashes zwsql on SCO 5.0.0 */
#ifndef __WIN__
#ifdef OS2
...
#define ZWSQL_UNIVERSAL_CLIENT_CHARSET "utf8"
#else
#define ZWSQL_UNIVERSAL_CLIENT_CHARSET ZWSQL_DEFAULT_CHARSET_NAME
#endif
